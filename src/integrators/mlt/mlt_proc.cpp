...
//                    std::cout << "current before :" << current->getRelativeWeight().toString() << " proposed before :" << proposed->getRelativeWeight().toString() << std::endl;
					...
					consecRejections = 0;
					++statsAccepted;
//                    std::cout << "current after :" << current->getRelativeWeight().toString() << " proposed afer :" << proposed->getRelativeWeight().toString() << std::endl;
				} else {
